...
Write a Python script that, using this [REST](https://jsonplaceholder.typicode.com/) API, for a given employee ID, returns information about his/her TODO list progress.
